...
const EVENTS = [
  ...
  },
  {
    ...
    title: 'Cup clink',
    category: 'indoor',
    tags: ['indoor', 'cafe', 'clink', 'one-shot', 'event'],
    source: 'cafe_murmur.ogg',
    startSec: 4,
    durationSec: 2.0,
    author: 'Freesound',
  },
  {
    ...
    title: 'Page turn',
    category: 'indoor',
    tags: ['indoor', 'library', 'page', 'one-shot', 'event'],
    source: 'library_quiet.ogg',
    startSec: 2,
    durationSec: 1.8,
    author: 'Freesound',
  },
  {
    ...
    title: 'City horn',
    category: 'urban',
    tags: ['urban', 'city', 'horn', 'one-shot', 'event'],
    source: 'city_soft.ogg',
    startSec: 6,
    durationSec: 2.2,
    author: 'Freesound',
  },
  {
    id: 'event_cricket_chirp',
    title: 'Cricket chirp',
    category: 'insects',
    tags: ['insects', 'cricket', 'night', 'one-shot', 'event'],
    source: 'crickets_night.ogg',
    startSec: 2,
    durationSec: 2.0,
    author: 'Freesound',
  },
  {
    ...
    title: 'Frog croak',
    category: 'frogs',
    tags: ['frogs', 'pond', 'croak', 'one-shot', 'event'],
    source: 'frogs_pond.ogg',
    startSec: 3,
    durationSec: 2.2,
    author: 'Freesound',
  },
  {
    id: 'event_water_splash',
    title: 'Water splash',
    category: 'water',
    tags: ['water', 'stream', 'splash', 'one-shot', 'event'],
    source: 'creek_rocks.ogg',
    startSec: 3,
    durationSec: 1.8,
    author: 'Freesound',
  },
  {
    ...
    title: 'Rail clack',
    category: 'transport',
    tags: ['transport', 'train', 'rail', 'one-shot', 'event'],
    source: 'train_steam_clickety.ogg',
    startSec: 2,
    durationSec: 2.0,
    author: 'Freesound',
  },
...
const LONG_META = {
  ...
  fireplace_indoor: { eventDurationSec: 1.5, preferOffsetSec: 3 },
  ...
  snow_wind: { eventDurationSec: 2.0, preferOffsetSec: 2 },
  cafe_murmur: { eventDurationSec: 2.2, preferOffsetSec: 4 },
  library_quiet: { eventDurationSec: 1.8, preferOffsetSec: 2 },
  ac_room: { eventDurationSec: 1.5, preferOffsetSec: 3 },
  city_soft: { eventDurationSec: 2.5, preferOffsetSec: 5 },
  park_city: { eventDurationSec: 2.0, preferOffsetSec: 3 },
  crickets_night: { eventDurationSec: 2.0, preferOffsetSec: 2 },
  frogs_pond: { eventDurationSec: 2.2, preferOffsetSec: 3 },
  creek_rocks: { eventDurationSec: 1.8, preferOffsetSec: 3 },
  river_wide: { eventDurationSec: 2.0, preferOffsetSec: 4 },
  fountain_plaza: { eventDurationSec: 1.8, preferOffsetSec: 2 },
  harbor_night: { eventDurationSec: 2.5, preferOffsetSec: 3 },
  train_steam_clickety: { eventDurationSec: 2.0, preferOffsetSec: 2 },
  train_ride: { eventDurationSec: 2.2, preferOffsetSec: 4 },
  metro_cabin: { eventDurationSec: 2.0, preferOffsetSec: 3 },
};
